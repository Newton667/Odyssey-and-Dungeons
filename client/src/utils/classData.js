...
export const CLASS_LEVELS = {
  ...
  Monk: { 1: ['Unarmored Defense', 'Martial Arts (d4)'], 2: ['Ki', 'Unarmored Movement (+10ft)'], 3: ['Monastic Tradition', 'Deflect Missiles'], 4: ['ASI', 'Slow Fall'], 5: ['Extra Attack', 'Martial Arts (d6)', 'Stunning Strike'], 6: ['Ki-Empowered Strikes', 'Tradition Feature'], 7: ['Evasion', 'Stillness of Mind'], 8: ['ASI'], 9: ['Unarmored Movement Improvement'], 10: ['Purity of Body'], 11: ['Martial Arts (d8)', 'Tradition Feature'], 12: ['ASI'], 13: ['Tongue of the Sun and Moon'], 14: ['Diamond Soul'], 15: ['Timeless Body'], 16: ['ASI'], 17: ['Martial Arts (d10)', 'Tradition Feature'], 18: ['Empty Body'], 19: ['ASI'], 20: ['Perfect Self'] },
